    ...
    <form method="POST" action="{{ route('model.update') }}" enctype="multipart/form-data">
        ...
        <div class="space-y-4">
            ...
            <div class="flex items-center justify-center w-full">
                <label for="dropzone-file-edit-model" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
